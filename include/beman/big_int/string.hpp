...
template <class C, std::size_t b, class LimbType, class A>
[[nodiscard]] constexpr std::basic_string<C> to_basic_string(const basic_big_int<b, LimbType, A>& x, const int base) {
...
[[nodiscard]] constexpr std::string to_string(const basic_big_int<b, LimbType, A>& x, const int base = 10) {
    return detail::to_basic_string<char>(x, base);
}

template <std::size_t b, class LimbType, class A>
[[nodiscard]] constexpr std::wstring to_wstring(const basic_big_int<b, LimbType, A>& x, const int base = 10) {

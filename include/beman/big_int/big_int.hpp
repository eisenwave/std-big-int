...
template <std::size_t min_inplace_bits,
          ...
          class Allocator = std::allocator<LimbType>>
class basic_big_int;

template <std::size_t b, class LimbType, class A>
constexpr std::from_chars_result from_chars(const char*, const char*, basic_big_int<b, LimbType, A>&, int = 10);

template <std::size_t b, class LimbType, class A>
constexpr std::to_chars_result to_chars(char*, char*, const basic_big_int<b, LimbType, A>&, int = 10);
...
template <std::size_t b, class LimbType, class A>
struct is_basic_big_int<basic_big_int<b, LimbType, A>> : std::true_type {};
...
template <std::size_t b, class LimbType, class A>
struct limb_type_of<basic_big_int<b, LimbType, A>> {
    using type = LimbType;
};
...
template <std::size_t b, class LimbType, class A, class T>
inline constexpr bool is_implicit_constructible_from =
    detail::signed_or_unsigned<std::remove_cvref_t<T>> ||
    std::is_same_v<std::remove_cvref_t<T>, basic_big_int<b, LimbType, A>>;
...
template <std::size_t min_inplace_bits, class LimbType, class Allocator>
class BEMAN_BIG_INT_TRIVIAL_ABI basic_big_int {
  ...
  public:
    ...
    template <std::size_t b, class OtherLimbType, class A>
    friend constexpr std::from_chars_result
    from_chars(const char*, const char*, basic_big_int<b, OtherLimbType, A>&, int);

    template <std::size_t b, class OtherLimbType, class A>
    friend constexpr std::to_chars_result to_chars(char*, char*, const basic_big_int<b, OtherLimbType, A>&, int);
...
template <std::size_t b, class LimbType, class A>
constexpr bool basic_big_int<b, LimbType, A>::is_representation_inplace() const noexcept {
    return m_capacity == 0;
}

template <std::size_t b, class LimbType, class A>
constexpr std::uint32_t basic_big_int<b, LimbType, A>::limb_count() const noexcept {
...
template <std::size_t b, class LimbType, class A>
constexpr bool basic_big_int<b, LimbType, A>::is_negative() const noexcept {
    constexpr std::uint32_t negative_zero_size_and_sign = 0x8000'0000U;
    BEMAN_BIG_INT_DEBUG_ASSERT(m_size_and_sign != negative_zero_size_and_sign);
...
template <std::size_t b, class LimbType, class A>
constexpr bool basic_big_int<b, LimbType, A>::is_zero() const noexcept {
...
template <std::size_t b, class LimbType, class A>
constexpr bool basic_big_int<b, LimbType, A>::unchecked_is_magnitude_zero() const noexcept {
...
template <std::size_t b, class LimbType, class A>
constexpr void basic_big_int<b, LimbType, A>::unchecked_set_limb_count(const std::uint32_t n) noexcept {
    BEMAN_BIG_INT_DEBUG_ASSERT(n != 0);
    m_size_and_sign = (m_size_and_sign & 0x8000'0000U) | n;
}

template <std::size_t b, class LimbType, class A>
constexpr void basic_big_int<b, LimbType, A>::unchecked_set_sign(const bool s) noexcept {
    m_size_and_sign = (m_size_and_sign & 0x7FFF'FFFFU) | (static_cast<std::uint32_t>(s) << 31);
}

template <std::size_t b, class LimbType, class A>
constexpr void basic_big_int<b, LimbType, A>::negate() noexcept {
    if (!is_zero()) {
...
template <std::size_t b, class LimbType, class A>
constexpr void basic_big_int<b, LimbType, A>::set_zero() noexcept {
    limb_ptr()[0]   = 0;
    m_size_and_sign = 1;
}

template <std::size_t b, class LimbType, class A>
constexpr void basic_big_int<b, LimbType, A>::unchecked_trim_magnitude() noexcept {
...
template <std::size_t b, class LimbType, class A>
constexpr auto basic_big_int<b, LimbType, A>::limb_ptr() noexcept -> limb_type* {
    return is_representation_inplace() ? m_storage.limbs : m_storage.data;
}

template <std::size_t b, class LimbType, class A>
constexpr auto basic_big_int<b, LimbType, A>::limb_ptr() const noexcept -> const limb_type* {
    return is_representation_inplace() ? m_storage.limbs : m_storage.data;
}

template <std::size_t b, class LimbType, class A>
constexpr std::span<uint_multiprecision_t> basic_big_int<b, LimbType, A>::limb_span() noexcept {
...
template <std::size_t b, class LimbType, class A>
constexpr basic_big_int<b, LimbType, A>::basic_big_int(const basic_big_int& x)
...
template <std::size_t b, class LimbType, class A>
constexpr basic_big_int<b, LimbType, A>::basic_big_int(basic_big_int&& x) noexcept
...
template <std::size_t b, class LimbType, class A>
constexpr basic_big_int<b, LimbType, A>& basic_big_int<b, LimbType, A>::operator=(const basic_big_int& x) {
    assign_value(x);
    return *this;
}

template <std::size_t b, class LimbType, class A>
constexpr basic_big_int<b, LimbType, A>& basic_big_int<b, LimbType, A>::operator=(basic_big_int&& x) noexcept {
...
template <std::size_t b, class LimbType, class A>
constexpr void basic_big_int<b, LimbType, A>::swap(basic_big_int& x) noexcept(
...
template <std::size_t b, class LimbType, class A>
template <detail::arbitrary_arithmetic T>
constexpr basic_big_int<b, LimbType, A>::basic_big_int(const T& value, const allocator_type& a) noexcept(
...
template <std::input_iterator I, std::sentinel_for<I> S>
    requires detail::signed_or_unsigned<std::iter_value_t<I>>
constexpr basic_big_int<b, LimbType, A>::basic_big_int(I begin, S end, const allocator_type& a)
    : m_capacity{0}, m_size_and_sign{1}, m_storage{}, m_alloc{a} {
...
template <std::size_t b, class LimbType, class A>
constexpr basic_big_int<b, LimbType, A>::~basic_big_int() {
    free_storage();
}
...
template <std::size_t b, class LimbType, class A>
template <detail::signed_or_unsigned S>
constexpr auto basic_big_int<b, LimbType, A>::operator>>=(const S s) -> basic_big_int& {
...
template <std::size_t b, class LimbType, class A>
constexpr bool basic_big_int<b, LimbType, A>::unchecked_increment_magnitude() {
...
template <std::size_t b, class LimbType, class A>
constexpr bool basic_big_int<b, LimbType, A>::unchecked_decrement_magnitude() {
    limb_type* const limbs     = limb_ptr();
    bool             borrow_in = true;
...
template <std::size_t b, class LimbType, class A>
constexpr void basic_big_int<b, LimbType, A>::shift_left(const shift_type s) {
    BEMAN_BIG_INT_DEBUG_ASSERT(s <= shift_max);
    if (s == 0) {
        return;
    }
...
template <std::size_t b, class LimbType, class A>
constexpr void basic_big_int<b, LimbType, A>::shift_right(const shift_type s) {
    BEMAN_BIG_INT_DEBUG_ASSERT(s <= shift_max);
    if (s == 0) {
        return;
    }
...
template <std::size_t b, class LimbType, class A>
constexpr std::size_t basic_big_int<b, LimbType, A>::width_mag() const noexcept {
...
template <std::size_t b, class LimbType, class A>
constexpr std::span<const uint_multiprecision_t> basic_big_int<b, LimbType, A>::representation() const noexcept {
    return {limb_ptr(), limb_count()};
}

template <std::size_t b, class LimbType, class A>
constexpr std::size_t basic_big_int<b, LimbType, A>::representation_size() const noexcept {
...
template <std::size_t b, class LimbType, class A>
constexpr typename basic_big_int<b, LimbType, A>::allocator_type
basic_big_int<b, LimbType, A>::get_allocator() const noexcept {
    return m_alloc;
}

template <std::size_t b, class LimbType, class A>
constexpr std::size_t basic_big_int<b, LimbType, A>::size() const noexcept {
    if (is_negative()) {
        basic_big_int<b, LimbType, A> negated(*this);
        negated.negate();
        return negated.size();
    } else if (is_zero()) {
        return std::size_t{0};
...
template <std::size_t b, class LimbType, class A>
constexpr std::size_t basic_big_int<b, LimbType, A>::max_size() noexcept {
    // Maximum number of bits the magnitude may occupy.
    return max_representation_size() * bits_per_limb;
}

template <std::size_t b, class LimbType, class A>
constexpr std::size_t basic_big_int<b, LimbType, A>::max_representation_size() noexcept {
...
template <std::size_t b, class LimbType, class A>
constexpr void basic_big_int<b, LimbType, A>::reserve(const size_type n) {
    // n is a bit count; reserve enough limbs to hold it.
    reserve_representation(detail::div_to_pos_inf(n, bits_per_limb));
}

template <std::size_t b, class LimbType, class A>
constexpr void basic_big_int<b, LimbType, A>::reserve_representation(const size_type n) {
    // Reserve room for at least n representation limbs.
    grow(n);
}

template <std::size_t b, class LimbType, class A>
constexpr auto basic_big_int<b, LimbType, A>::capacity() const noexcept -> size_type {
    // Number of bits of storage currently available without reallocating.
    return representation_capacity() * bits_per_limb;
}

template <std::size_t b, class LimbType, class A>
constexpr auto basic_big_int<b, LimbType, A>::representation_capacity() const noexcept -> size_type {
...
template <std::size_t b, class LimbType, class A>
constexpr void basic_big_int<b, LimbType, A>::shrink_to_fit() {
    const auto count = limb_count();
...
template <std::size_t b, class LimbType, class A>
constexpr auto basic_big_int<b, LimbType, A>::operator+() const& -> basic_big_int {
    return *this;
}

template <std::size_t b, class LimbType, class A>
constexpr auto basic_big_int<b, LimbType, A>::operator+() && noexcept -> basic_big_int {
...
template <std::size_t b, class LimbType, class A>
constexpr auto basic_big_int<b, LimbType, A>::operator~() && -> basic_big_int {
...
template <std::size_t b, class LimbType, class A>
constexpr auto basic_big_int<b, LimbType, A>::operator++(int) & -> basic_big_int {
    auto copy = *this;
    ++(*this);
    return copy;
}
...
constexpr T basic_big_int<b, LimbType, A>::to() const noexcept {
...
template <std::size_t b, class LimbType, class A>
template <detail::bitwise_op op, class T>
constexpr auto basic_big_int<b, LimbType, A>::bitwise_assign_impl(T&& rhs) -> basic_big_int&
    requires detail::common_big_int_type_with<T, basic_big_int>
{
...
// exact same `basic_big_int<b, LimbType, A>` instantiation, so the operand type already matches
...
template <std::size_t b, class LimbType, class A>
template <detail::bitwise_op op, class L, class R>
constexpr detail::common_big_int_type<L, R> basic_big_int<b, LimbType, A>::bitwise_impl(L&& x, R&& y) {
    using Result        = detail::common_big_int_type<L, R>;
    constexpr auto form = detail::classify_form_v<L, R>;
...
template <detail::bitwise_op op, std::size_t extent>
constexpr void
basic_big_int<b, LimbType, A>::bitwise_in_place(const std::span<const uint_multiprecision_t, extent> other,
...
template <std::size_t b, class LimbType, class A>
template <detail::signed_or_unsigned Integer>
constexpr bool basic_big_int<b, LimbType, A>::equals_integer(const Integer x) const noexcept {
...
template <std::size_t b, class LimbType, class A>
constexpr bool basic_big_int<b, LimbType, A>::equals_big_int(const basic_big_int& x) const noexcept {
...
template <std::size_t b, class LimbType, class A>
template <std::size_t extent>
constexpr bool basic_big_int<b, LimbType, A>::equals_limbs(const std::span<const uint_multiprecision_t, extent> limbs,
...
template <std::size_t b, class LimbType, class A>
template <detail::signed_or_unsigned Integer>
constexpr std::strong_ordering basic_big_int<b, LimbType, A>::compare_integer(const Integer x) const noexcept {
    if constexpr (std::is_unsigned_v<Integer>) {
        if (is_negative()) {
            return std::strong_ordering::less;
        }
...
template <std::size_t b, class LimbType, class A>
constexpr std::strong_ordering basic_big_int<b, LimbType, A>::compare_big_int(const basic_big_int& x) const noexcept {
    // We can do fancier things in the future, but this works for now.
...
basic_big_int<b, LimbType, A>::compare_limbs(const std::span<const uint_multiprecision_t, extent> limbs,
                                             const bool limbs_negative) const noexcept {
...
template <std::size_t extent_other>
constexpr void
basic_big_int<b, LimbType, A>::add_in_place(const std::span<const uint_multiprecision_t, extent_other> other,
                                            const bool                                                 other_neg) {
    const bool this_neg = is_negative();
...
template <std::size_t b, class LimbType, class A>
template <std::size_t extent_a, std::size_t extent_b>
constexpr void basic_big_int<b, LimbType, A>::add_into(const std::span<const uint_multiprecision_t, extent_a> a,
                                                       const bool                                             a_neg,
...
template <std::size_t extent_a, std::size_t extent_b>
constexpr void
basic_big_int<b, LimbType, A>::multiply_into(const std::span<const uint_multiprecision_t, extent_a> a,
                                             const bool                                             a_neg,
                                             const std::span<const uint_multiprecision_t, extent_b> b_span,
                                             const bool                                             b_neg) {
...
template <std::size_t b, class LimbType, class A>
template <detail::bitwise_op op, bool neg_left, bool neg_right, std::size_t extent_a, std::size_t extent_b>
constexpr basic_big_int<b, LimbType, A>
basic_big_int<b, LimbType, A>::make_bitwise_of_limbs(const std::span<const uint_multiprecision_t, extent_a> lhs,
                                                     const std::span<const uint_multiprecision_t, extent_b> rhs) {
...
template <detail::bitwise_op op, std::size_t extent_a, std::size_t extent_b>
constexpr basic_big_int<b, LimbType, A>
basic_big_int<b, LimbType, A>::dispatch_bitwise(const std::span<const uint_multiprecision_t, extent_a> lhs,
                                                const bool                                             lhs_neg,
                                                const std::span<const uint_multiprecision_t, extent_b> rhs,
                                                const bool                                             rhs_neg) {
    if (!lhs_neg && !rhs_neg) {
...
template <std::size_t b, class LimbType, class A>
template <class T>
constexpr auto basic_big_int<b, LimbType, A>::operator+=(T&& rhs) -> basic_big_int&
    requires detail::common_big_int_type_with<T, basic_big_int>
{
    if constexpr (detail::is_basic_big_int_v<std::remove_cvref_t<T>>) {
...
template <std::size_t extent_a>
constexpr uint_multiprecision_t
basic_big_int<b, LimbType, A>::divmod_into_short(const std::span<const uint_multiprecision_t, extent_a> dividend,
...
template <std::size_t b, class LimbType, class A>
constexpr uint_multiprecision_t basic_big_int<b, LimbType, A>::divmod_in_place_short(
...
template <std::size_t extent_a, std::size_t extent_b>
constexpr auto
basic_big_int<b, LimbType, A>::divmod_into(const std::span<const uint_multiprecision_t, extent_a> dividend,
                                           const bool                                             dividend_neg,
...
template <std::size_t b, class LimbType, class A>
template <detail::unsigned_integer T>
constexpr void basic_big_int<b, LimbType, A>::assign_magnitude(T value) noexcept {
...
template <std::size_t b, class LimbType, class A>
template <detail::cv_unqualified_floating_point F>
constexpr void basic_big_int<b, LimbType, A>::assign_from_float(const F value) noexcept {
...
template <std::size_t b, class LimbType, class A>
constexpr auto basic_big_int<b, LimbType, A>::alloc_limbs(const size_type n) -> alloc_result {
...
template <std::size_t b, class LimbType, class A>
constexpr void basic_big_int<b, LimbType, A>::free_limbs(pointer p, const size_type n) {
...
template <std::size_t b, class LimbType, class A>
constexpr void basic_big_int<b, LimbType, A>::free_storage() {
    if (!is_representation_inplace()) {
        free_limbs(m_storage.data, m_capacity);
    }
}
...
template <std::size_t b, class LimbType, class A>
constexpr void basic_big_int<b, LimbType, A>::grow(const size_type limbs_needed) {
...
template <std::size_t b, class LimbType, class A>
constexpr void basic_big_int<b, LimbType, A>::copy_n_to_allocation(const limb_type* const p,
                                                                   const size_type        n,
...
template <std::size_t b, class LimbType, class A>
constexpr void basic_big_int<b, LimbType, A>::push_back_limb(limb_type limb) {
    const auto count = limb_count();
...
// `basic_big_int<N, LimbType, A>` whose inline storage is large enough to hold the value
...
using basic_big_int = beman::big_int::basic_big_int<b, LimbType, std::pmr::polymorphic_allocator<LimbType>>;
...
template <std::size_t b, class LimbType, class A>
struct std::hash<beman::big_int::basic_big_int<b, LimbType, A>> {

    std::size_t operator()(const beman::big_int::basic_big_int<b, LimbType, A>& x) const noexcept {

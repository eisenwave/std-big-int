...
= `std::big_int`: A reference implementation for https://isocpp.org/files/papers/D4444R0.html[P4444]
...
This repository contains our reference implementation of `std::big_int`.
...
`std::big_int` requires a minimum of pass:[C++23], and is tested on the following compilers:

...
TEST(InRange, ValuesInRange) {
    ...
    EXPECT_EQ(in_range<std::int16_t>(big_int(std::numeric_limits<std::int16_t>::min()), true);
    EXPECT_EQ(in_range<std::int16_t>(big_int(std::numeric_limits<std::int16_t>::max()), true);

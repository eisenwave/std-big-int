...
#ifndef _MSC_VER
    // 2^1398269 - 1
    const std::string control_val{
        "1ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
        ...
        "fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
        "fffff"};
    ASSERT_EQ(control_val.size(), 349'568); // 1 followed by 349,567 Fs

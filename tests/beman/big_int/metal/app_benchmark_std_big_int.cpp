...
// mkdir -p bin
// arm-none-eabi-g++ -std=c++23 -Wall -Wextra -Wpedantic -O0 -g -gdwarf-2 -ffunction-sections -fdata-sections -x c++ -fno-rtti -fno-use-cxa-atexit -fno-exceptions -fno-nonansi-builtins -fno-threadsafe-statics -fno-enforce-eh-specs -ftemplate-depth=128 -mcpu=cortex-m4 -mtune=cortex-m4 -mthumb -mfloat-abi=soft -mno-unaligned-access -mno-long-calls -I../../../../include -DAPP_BENCHMARK_STANDALONE_MAIN app_benchmark_std_big_int.cpp ./target/micros/stm32f429/make/single/crt.cpp ./target/micros/stm32f429/make/single/mcal_gcc_cxx_completion.cpp ../../../../src/divide.cpp ../../../../src/fft_mul.cpp ../../../../src/karatsuba.cpp ../../../../src/mulmod_bnm1.cpp ../../../../src/mul_dispatch.cpp ../../../../src/ntt.cpp ../../../../src/toom_cook_3.cpp ../../../../src/toom_cook_4.cpp ../../../../src/toom_cook_6_5.cpp ../../../../src/toom_cook_8_5.cpp -nostartfiles -Wl,--gc-sections -Wl,-Map,./bin/app_benchmark_std_big_int.map -T ./target/micros/stm32f429/make/stm32f429.ld -Wl,--print-memory-usage -o ./bin/app_benchmark_std_big_int.elf
